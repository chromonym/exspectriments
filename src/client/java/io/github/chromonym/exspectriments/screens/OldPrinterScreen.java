...
public class OldPrinterScreen extends HandledScreen<PrinterScreenHandler> {
    ...
    public OldPrinterScreen(PrinterScreenHandler handler, PlayerInventory inventory, Text title) {
